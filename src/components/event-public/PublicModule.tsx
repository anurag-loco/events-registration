...
import { DEFAULT_BRAND_COLOR, DEFAULT_MODULE } from "@/lib/component-defaults";
  ...
  return (
    <section className={`relative w-full px-5 sm:px-8 lg:px-12 py-16 sm:py-24 lg:py-36`}>
      <div className={variant === "wide" ? "max-w-[1400px] mx-auto" : "max-w-5xl mx-auto"}>
        {(eyebrow || heading) && (
          <div className="mb-10 sm:mb-14 lg:mb-20 max-w-3xl">
            {eyebrow && (
              <p
...
function WhyAttend({ module: m, brandColor }: ModuleProps) {
  ...
  return (
    <SectionShell eyebrow="Why attend" heading={heading} brandColor={brandColor} variant="wide">
      <div className="grid grid-cols-1 lg:grid-cols-6 lg:auto-rows-[minmax(180px,auto)] gap-3 sm:gap-4">
...
export function PublicModule({
  ...
  const props = { module, brandColor, index };
